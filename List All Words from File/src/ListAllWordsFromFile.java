...
public class ListAllWordsFromFile {
   ...
   public static void main(String[] args) {
      ...
      try {
         ...
         String word = readNextWord(wordList);
         while (word != null) {
    ...
    * @param wordList
    */
   private static String readNextWord(ArrayList<String> wordList) {
      ...
      StringBuilder word = new StringBuilder();  // This will be the word that is read.
      while (true) {
      ...
      return word.toString();  // Return the word that has been read.
   }
