...
public class ScratchOff extends Application {
    ...
    private final int[] sizes = { 10, 20, 35, 60 };  // sizes for the square that
                                                     ...
                                                     // drags the mouse 
    												 // corresponds to a word in a dropdown menu
    private double scratcherSize; // current size of the rectangle; one of the
                                  // items from the previous array, depending on
    ...
    public void start(Stage stage) {
        ...
        sizeSelect.getItems().addAll("Small", "Normal", "Big", "Giant"); //sizes are small, normal, big, giant
        ...
        stage.setTitle("Scratch Off to Reveal a Picture!");
        stage.show();
